...
import { Plus, X, BookOpen, BrainCircuit, Filter, BarChart3, Trash2, Search, Volume2, Gauge, Globe } from 'lucide-react';
import './App.css';

// =========================================
// СЛОВАРЬ ПЕРЕВОДОВ ИНТЕРФЕЙСА (8 языков)
// =========================================
const TRANSLATIONS = {
  ru: {
    appTitle: "Мой Словарь", tabDict: "Словарь", tabTrain: "Тренировка", tabStats: "Статистика", logout: "Выйти",
    ...
    editTitle: "Характеристика", confirmDel: "Точно удалить слово?", errExists: "уже есть!", errEngReq: "Впиши слово на английском!", errImg: "Ошибка поиска картинок",
  ...
  uk: {
    appTitle: "Мій Словник", tabDict: "Словник", tabTrain: "Тренування", tabStats: "Статистика", logout: "Вийти",
    ...
    editTitle: "Характеристика", confirmDel: "Точно видалити слово?", errExists: "вже є!", errEngReq: "Впиши слово англійською!", errImg: "Помилка пошуку картинок",
  ...
  en: {
    appTitle: "My Dictionary", tabDict: "Dictionary", tabTrain: "Training", tabStats: "Statistics", logout: "Logout",
  ...
  es: {
    appTitle: "Mi Diccionario", tabDict: "Diccionario", tabTrain: "Entrenamiento", tabStats: "Estadísticas", logout: "Salir",
    ...
    editTitle: "Detalles", confirmDel: "¿Seguro que quieres borrarlo?", errExists: "¡ya existe!", errEngReq: "¡Escribe la palabra en inglés primero!", errImg: "Error al buscar imágenes",
    ...
    hardTitle: "Palabras difíciles", hardSubAll: "Palabras que marcaste 'Otra vez'", hardSubTheme: "Difíciles en tema", hardEmpty: "¡Bien hecho, no hay palabras difíciles!",
  ...
  fr: {
    appTitle: "Mon Dico", tabDict: "Dictionnaire", tabTrain: "Entraînement", tabStats: "Statistiques", logout: "Quitter",
    search: "Chercher...", filterAll: "Tous les thèmes", sortNew: "Nouveaux", sortEn: "A-Z (Anglais)", sortRu: "A-Z (Traduction)",
    ...
    editTitle: "Détails", confirmDel: "Voulez-vous vraiment supprimer ?", errExists: "existe déjà !", errEngReq: "Entrez d'abord le mot en anglais !", errImg: "Erreur d'image",
    ...
    hardTitle: "Mots difficiles", hardSubAll: "Mots marqués 'Encore'", hardSubTheme: "Mots difficiles du thème", hardEmpty: "Super, aucun mot difficile !",
  ...
  de: {
    appTitle: "Mein Wörterbuch", tabDict: "Wörterbuch", tabTrain: "Training", tabStats: "Statistik", logout: "Abmelden",
    search: "Wort suchen...", filterAll: "Alle Themen", sortNew: "Neu", sortEn: "A-Z (Englisch)", sortRu: "A-Z (Übersetzung)",
    ...
    editTitle: "Details", confirmDel: "Wirklich löschen?", errExists: "existiert bereits!", errEngReq: "Gib zuerst das englische Wort ein!", errImg: "Bildfehler",
    trainModeEnRu: "🇬🇧 Eng ➔ Über", trainModeRuEn: "🔄 Über ➔ Eng", trainModeRand: "🔀 Zufällig", trainLeft: "Übrig:",
    clickFlip: "Klicken zum Umdrehen", rateAgain: "Nochmal", rateHard: "Schwer", rateGood: "Gut", rateEasy: "Einfach",
    ...
    hardTitle: "Schwerste Wörter", hardSubAll: "Wörter mit 'Nochmal'", hardSubTheme: "Schwer im Thema", hardEmpty: "Super, keine schweren Wörter!",
    themeAnalysis: "Themen-Analyse", themeSub: "Beherrschungsgrad", tGood: "Gut", tOk: "Mittel", tHard: "Schwer",
    authLog: "Anmelden", authReg: "Registrieren", authEmail: "E-Mail", authPass: "Passwort", authBtnLog: "Anmelden", authBtnReg: "Erstellen", authTogReg: "Registrieren", authTogLog: "Anmelden", authOk: "Erfolg! Klicke auf 'Anmelden'"
  },
  ja: {
    appTitle: "私の辞書", tabDict: "辞書", tabTrain: "トレーニング", tabStats: "統計", logout: "ログアウト",
    ...
    editTitle: "詳細", confirmDel: "本当に削除しますか？", errExists: "すでに存在します！", errEngReq: "まず英単語を入力してください！", errImg: "画像検索エラー",
    ...
    hardTitle: "苦手な単語", hardSubAll: "「もう一度」を押した単語", hardSubTheme: "テーマ内の苦手な単語", hardEmpty: "素晴らしい、苦手な単語はありません！",
    themeAnalysis: "テーマ分析", themeSub: "習熟度", tGood: "良い", tOk: "普通", tHard: "難しい",
    authLog: "ログイン", authReg: "登録", authEmail: "メール", authPass: "パスワード", authBtnLog: "ログイン", authBtnReg: "作成", authTogReg: "登録", authTogLog: "ログイン", authOk: "成功！「ログイン」を押してください"
  },
  zh: {
    appTitle: "我的字典", tabDict: "字典", tabTrain: "训练", tabStats: "统计", logout: "登出",
    ...
    editTitle: "详情", confirmDel: "确定要删除吗？", errExists: "已存在！", errEngReq: "请先输入英语单词！", errImg: "图片搜索错误",
    ...
    hardTitle: "最难单词", hardSubAll: "你点击'重来'的单词", hardSubTheme: "主题中的难词", hardEmpty: "太棒了，没有难词！",
    themeAnalysis: "主题分析", themeSub: "掌握程度", tGood: "好", tOk: "中等", tHard: "难",
    authLog: "登录", authReg: "注册", authEmail: "邮箱", authPass: "密码", authBtnLog: "登录", authBtnReg: "创建", authTogReg: "注册", authTogLog: "登录", authOk: "成功！现在点击'登录'"
  }
};
  ...
  return (
    <div className="app-container">
      ...
      <main className="content">
        {activeTab === 'dictionary' && <Dictionary session={session} speechRate={speechRate} t={t} />}
...
// 1. СЛОВАРЬ
// =========================================
function Dictionary({ session, speechRate, t }) {
      ...
      <div className="glass-panel" style={{ position: 'relative' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', right: '16px', display: 'flex', gap: '4px', alignItems: 'center' }}>
          ...
          <select 
            ...
            style={{ border: 'none', background: 'transparent', outline: 'none', color: '#495057', cursor: 'pointer', fontSize: '14px', fontWeight: '600' }}
          >
            <option value="uk">🇺🇦 Укр</option>
            <option value="ru">🇷🇺 Рус</option>
            <option value="en">🇬🇧 Eng</option>
